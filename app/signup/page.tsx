  ...
  return (
    <div className="min-h-screen relative overflow-x-hidden bg-[#02020A]">
      ...
      <div className="z-10 text-center mb-10 flex flex-col items-center">
        ...
        <p className="text-white/70 font-light text-sm">Join the Ignisia Intelligence Network</p>
      </div>
      ...
      >
        ...
        <div className="mt-8 pt-8 border-t border-white/15 text-center">
          <p className="text-white/45 text-xs">
            ...
            <Link href="/login" className="text-[#1E2CFF] hover:text-[#B06CFF] transition-colors font-medium">
              Sign In
            </Link>
          </p>
        </div>
